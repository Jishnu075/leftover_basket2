...
import 'package:leftover_basket/screens/receiver_home_screen.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text('About Leftover Basket'),
        ),
        body: Container(
              ...
              children: <Widget>[
                ...
                Padding(
                    ...
                    child:
                        ...
                        AutoSizeText(
                            '                at Leftover Basket aim to provide help to the society in a way which is beneficial for everyone. This app is a platform that works to connect the avaliable donors to recpients who can provide the needy. ',
                            style: TextStyle(
                              fontSize: 18,
                            ))),
                SizedBox(height: 10),
                ...
                Padding(
                    ...
                    child: Text(
                        'Soumya K sunil, Jishnu Biju, Ameesha Shajan, Steffi Stephen.',
                        style: TextStyle(
                            fontSize: 18,
